        ...
        <div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div>
                        ...
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input id="username" type="text" name="username" value="{{ old('username') }}"  autofocus required class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('username') border-red-300 text-red-900 placeholder-red-300 focus:border-red-300 focus:shadow-outline-red @enderror" />
                            @error('username')
                    ...
                    <div class="mt-6">
                        ...
                        <!-- email confirm-->
                    <div class="mt-6">
                        <label for="email_confirm" class="block text-sm font-medium leading-5 text-gray-700">
                            {{ __('Email Address confirmation') }}
                        </label>
                        <div class="mt-1 relative rounded-md shadow-sm">
                            <input id="email_confirmation" type="email" name="email_confirmation" value="{{ old('email_confirmation') }}"  autocomplete="email_confirmation" autofocus required class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('email_confirmation') border-red-300 text-red-900 placeholder-red-300 focus:border-red-300 focus:shadow-outline-red @enderror" />
            ...
            <!-- Date of Birth-->
                        <div class="mt-6">
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                <input id="dob" type="date" name="dob" required placeholder="dd-mm-yyyy" value="{{ old('dob') }}" class="appearance-none block w-full px-3 py-2 border border-gray-300 rounded-md placeholder-gray-400 focus:outline-none focus:shadow-outline-blue focus:border-blue-300 transition duration-150 ease-in-out sm:text-sm sm:leading-5 @error('dob') border-red-300 text-red-900 placeholder-red-300 focus:border-red-300 focus:shadow-outline-red @enderror" />
                                @error('dob')
                                <div class="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-red-500" fill="currentColor" viewBox="0 0 20 20">
                                        <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd" />
                ...
                <!-- TOS-->
                        <div class="mt-6 flex items-center justify-between">
                            <div class="flex items-center">
                                <input id="tos" type="checkbox" name="tos" class="form-checkbox h-4 w-4 text-indigo-600 transition duration-150 ease-in-out" />
                                <label for="tos" class="ml-2 block text-sm leading-5 text-gray-900">
                                    {{ __('I have read and agree to the ') }}<a href="{{route('tos')}}" class="text-indigo-600">{{__('Terms of Service')}}</a>
                                </label>
                            </div>
                        </div>
                    <div class="mt-6">
